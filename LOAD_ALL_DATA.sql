-- Container Planning Demo - Complete Data Load
-- Copy and paste this entire SQL into Supabase SQL Editor
-- This includes all 4 containers with 20 items each (80 total items)
...
-- Insert container items (fictional data with 20 entries per container = 80 total items)
...
SELECT 'Containers' as table_name, COUNT(*) as count FROM containers
UNION ALL
SELECT 'Suppliers' as table_name, COUNT(*) as count FROM suppliers
UNION ALL
SELECT 'Container Items' as table_name, COUNT(*) as count FROM container_items
UNION ALL
SELECT 'Arrivals' as table_name, COUNT(*) as count FROM arrivals
UNION ALL
SELECT 'Entypo Paralavis' as table_name, COUNT(*) as count FROM entypo_paralavis;

-- Show items per container
